 ...
 */
contract LSDStakingNode is
  ILSDStakingNode,
  Initializable,
  ReentrancyGuardUpgradeable,
  ILSDStakingNodeEvents
{
  ...
  function initialize(Init memory init) public notZeroAddress(address(init.ynLSD)) initializer {
  ...
  ) external nonReentrant onlyLSDRestakingManager {
